var Clock = (function() {
    ...
    return {
        ...
        ui: function() {
            ...
            var toggleOptions = document.getElementById('toggle-options'),
                ...
                use24HourBtn = document.getElementById('use24Hour');
            ...
            use24HourBtn.addEventListener('click', function(e) {
                e.preventDefault();
                if(use24HourBtn.className === 'on') {
                    use24HourBtn.className = '';
                    use24Hour = false;
                } else {
                    use24HourBtn.className = 'on';
                    use24Hour = true;
                }
            }, false);
  ...
  var FPS = {
    ...
    update: function(fpsID) {    
        ...
        this.frames++;
        this.updateFrames++;
        document.getElementById(fpsID).innerHTML = "FPS 平均: " + Math.round(1000 * this.frames / this.  totalTime) + " Current: " + Math.round(1000 * this.updateFrames / this.updateTime);
